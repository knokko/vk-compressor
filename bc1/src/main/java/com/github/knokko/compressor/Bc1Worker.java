...
public class Bc1Worker {
	...
	/**
	 * Calls <i>vkCmdBindPipeline</i> to bind the bc1 compute pipeline. You must call this before calling any of the
	...
	public void compress(
		...
		if (!compressor.didStagingTransfer) {
			throw new IllegalStateException("You need to call compressor.performStagingTransfer() first");
		}
